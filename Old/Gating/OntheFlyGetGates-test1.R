...
#input_path = "/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/Analysis/GatingEXPERIMENTS/April20/fsc"

#testing
input_path = "/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/FlowDataFiles/Exported_gating_9MBO/sample_on_the_fly/flowset"


# where should I save the data?
output_path <- "/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/FlowDataFiles/Exported_gating_9MBO/50000cells"
...
# this is the flowset file we just saves (a csv)
input_path <- "/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/Analysis/GatingEXPERIMENTS/April20/flowset.csv"
# for testing start here read in the 50 000 subset cells
input_path <- "/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/FlowDataFiles/Exported_gating_9MBO/sample_on_the_fly/flowset/flowset.csv"
...
# improve labels for reference
# Idents(seu.r) <- "labels5"
# cluster.ids <- c("Mix","RG-CD184","Neurons-mix","Neurons-CD56","Neurons-CD24","Astro-AQP4","Glia-CD44","RG-CD133","Neurons-CD15","RG-CD184","Endo","Glia-CD44","Neurons-CD56","Glia-glast","Astro-CD71","RG-CD133","Glia-CD44","Oligo","Mix","OPC","Neurons-CD15","Epilthelial")
# 
# names(cluster.ids) <- levels(seu.r)
# seu.r<- RenameIdents(seu.r, cluster.ids)
# seu.r$ref.cells <- Idents(seu.r)
# DimPlot(seu.r)
# 
# saveRDS(seu.r,"/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/Analysis/9MBO/prepro_outsjan20-9000cells/Figure3/Louvkn60DifferentCellLabels220220318.Rds")
# 
...
cluster.ids <- c("Mix-RG","Neurons-CD24","Glia-CD44-neurons","RG-CD184","Mix-neurons","Neurons-CD56",
  "Neurons-CD56","Glia-glast","Neurons-CD24-CD56","RG-CD184-n","RG-CD184-a","Glia-CD44","Neurons-CD56-CD15",
  "Neurons-CD15","Neurons-CD24-CD56","Astro-AQP4-RG","Neurons-CD56","Glia-CD44-RG","RG-CD184","Astro-CD71",
  "Neurons-CD24","RG-CD133","Neurons-CD15","Neurons-CD24")
...
Idents(seu) <- "seurat_clusters"
cluster.ids <- c("other-glia","Neurons2","Astro","glia","other-neurons","Neurons1",
                 "Neurons1","glia","Neurons","other-glia","glia","Astro","glia","Neurons3",
                 "Neurons","glia","Neurons1","Astro","glia","glia","Neurons2",
                 "RG2","Neurons3","glia")
names(cluster.ids) <- levels(seu)
seu <- RenameIdents(seu, cluster.ids)
...
saveRDS(seu,paste(output_path,"Firsttest_seuLabels.Rds"))


#### test if the labeling can work well on fewer clusters to save time
...
cell.types <- c("Neurons1", "Neurons2","Neurons","glia", "other","RG2","Neurons3", "other")

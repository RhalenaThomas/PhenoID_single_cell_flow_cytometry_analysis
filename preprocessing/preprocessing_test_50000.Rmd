...
Functions to be called later - run code chunk to have the function 'callable' in your working environment
...
```{r,include=FALSE}
# desired total is 50000
# one sample has only 1578
# the remained divided by 8 is 6052
desired_size <- 6052

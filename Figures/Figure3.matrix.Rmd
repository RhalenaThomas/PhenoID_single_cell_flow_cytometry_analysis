...
# reorder AB
A <- A2 %>% select(c("X","CD24","CD56","CD71","CD29","CD15", "CD184","CD133", "Glast","CD44","AQP4","HepaCam","CD140a", "O4" ))
...
pdf("/Users/rhalenathomas/Documents/Projects_Papers/PhenoID/ForFigures/ReferenceMatrix9celltypes.pdf", width = 5, height = 4)
ggplot(longData, aes(x = variable, y = X)) + 
  geom_raster(aes(fill=value)) + 
  scale_fill_gradient(low="grey90", high="red", na.value = "grey") +
  labs(x="Antibodies", y="Cell Types", title="Matrix") +

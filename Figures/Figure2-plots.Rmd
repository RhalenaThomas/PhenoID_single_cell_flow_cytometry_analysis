...
# output pathway
output_path <- "/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/Analysis/2Dcells_surface/Figure2/"
...
```{r}
seu2 <- readRDS("/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/Analysis/2Dcells_surface/Figure2/Flowset_SelectSeuratlabels.Rds")
```
...
Idents(seu2) <- 'Batch'
A <- WhichCells(seu2, idents = c("Astrocytes"))
I <- WhichCells(seu2, idents = c("IPSC"))
N <- WhichCells(seu2, idents = c("Neurons"))
NPC <- WhichCells(seu2, idents = c("NPC"))
O <- WhichCells(seu2, idents = c("Oligo"))
